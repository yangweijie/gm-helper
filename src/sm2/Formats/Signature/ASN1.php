<?php
namespace sm\sm2\Formats\Signature;
...
class ASN1
{
     ...
     */
    public static function rsToAsn1(string $r, string $s, $outFormat = 'base64'): string
    {
    ...
    public static function asn1ToRs($asn1Str,$inFormat='base64'): array
    {
